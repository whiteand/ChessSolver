...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
procedure DoMove(var board: TBoard; var makedMoves: TMoves; var m: Move);
begin
  with m do
  begin
...
begin
  ...
  res := IsUnderAttackBy(board, OppositeColor(color), i,j);
  IsCheckTo := res;
end;
//-----------------------------------------------------------------------------
...
begin
  ...
  begin
    ...
    begin
      DoMove(board, makedMoves, moves.items[i]);
      {$IFDEF SHOULD_LOG}
      WriteLn;
